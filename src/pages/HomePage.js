...
const HomePage =() => (
    <>
        <h1 style={{borderTop: "3px solid black",borderLeft:"3px solid black",borderRight:"3px solid black",marginBottom: "0%", marginTop:"2%"}}className ='title'>MOOVIT OR LOOZIT</h1>
    <h2  style={{borderLeft:"3px solid black",borderRight:"3px solid black", borderBottom: "3px solid black",marginTop: "0%",marginBottom:"2%"}} className ='title'> MOOVING CO.</h2>
<div className='hompage-head'style={{borderTop:"3px solid black",borderLeft:"3px solid black",borderRight:"3px solid black",display:"flex", justifyContent:"space-evenly", alignContent:"baseline", backgroundColor:"white", marginLeft:"7%", marginRight:"7%", paddingTop: "7%"}}>
